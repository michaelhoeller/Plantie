...
public class CenterControl {
    ...
    private Integer              autoModeInterval    = 60;
    ...
    public Integer getAutoModeInterval() {
        return autoModeInterval;
    }
    
    public void setAutoModeInterval(Integer autoModeInterval) {
        this.autoModeInterval = autoModeInterval;
    }
}
