...
public class MainPage extends JFrame {
    ...
    private JMenuItem         mntmAutoModeConfiguration;
    ...
    private JMenu getMnControlCenter() {
        if (mnControlCenter == null) {
            ...
            mnControlCenter.add(getMntmAutoModeConfiguration());
        }
    ...
    private JMenuItem getMntmAutoModeConfiguration() {
        if (mntmAutoModeConfiguration == null) {
            mntmAutoModeConfiguration = new JMenuItem("Auto mode configuration");
            mntmAutoModeConfiguration.addActionListener(new ActionListener() {
                
                public void actionPerformed(ActionEvent e) {
                    mainPage.setEnabled(false);
                    new AutoModeConfigurator(mainPage);
                }
            });
        }
        return mntmAutoModeConfiguration;
    }
